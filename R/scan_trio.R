#' Calculating Scan-Trio statistic for user-defined windows
...
#' @export
#'
#' @examples scan_trio(filepath.vcf, filepath.ped)
#' @examples scan_trio(filepath.vcf, filepath.ped, window.size=10, window.type="M")
#'
#' @export
#'
...
testStatForData<-.getTestStatForData(windows)
testStatForPermutedData<-.getTestStatForPermutedData(windows)
pValForData<-calculateSignificance(testStatForData, testStatForPermutedData)
...
#Make sure you use apply for this…
