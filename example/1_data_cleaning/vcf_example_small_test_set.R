...
#Write out
filepath.sm.vcf<-"/dcl01/beaty/data/gmkf/euro/vcfs/filtered/8q24.recode.100snps.vcf"
writeVcf(sm.vcf,filepath.sm.vcf)

filepath.cluster<-"/dcl01/beaty/data/gmkf/euro/vcfs/filtered/8q24.recode.100snps.vcf"
filepath.destination<-"'/Users/lindagai 1/Documents/classes/4th year/Research/rvtrio/data'"
...
#Even smaller test set

filepath.vcf<-"/Users/lindagai 1/Documents/classes/4th year/Research/rvtrio/data/8q24.recode.100snps.vcf"
hg.assembly<-"hg19"
...
filepath.sm.vcf<-"/Users/lindagai 1/Documents/classes/4th year/Research/rvtrio/data/8q24.recode.10snps.vcf"
writeVcf(sm.vcf,filepath.sm.vcf)
